...
<main>
    ...
    <div class="container">
        ...
        <main class="row">
                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="w-100 btn btn-success btn-lg btn-outline-primary">Купить</button>
                        </div>
                    </div>
                </div>
                <div class="col-8">
                    <div class="card mb-4 rounded-3 shadow-sm">
                      <div class="card-body">
                        <form>
                          <div class="mb-3">
                            <input name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="Имя" aria-describedby="emailHelp">
                          </div>
                          <div class="mb-3">
            ...
            <div class="row text-center">
                <h3 class="h3 text-center">FAQ</h3>
                ...
                <div class="collapse" id="collapseExample1">
                    <div class="card card-body">
                        Как купить? -- Как купить? -- Как купить? -- Как купить? -- Как купить? -- Как купить?
                    </div>
                </div>
                <div class="collapse" id="collapseExample2">
                    <div class="card card-body">
                        Как доставить? -- Как доставить? -- Как доставить? -- Как доставить? -- Как доставить? -- Как доставить?
                    </div>
                </div>
                <div class="collapse" id="collapseExample3">
                    <div class="card card-body">
                        Какая гарантия??? -- Какая гарантия??? -- Какая гарантия??? -- Какая гарантия??? -- Какая гарантия??? -- Какая гарантия???
                    </div>
                </div>
